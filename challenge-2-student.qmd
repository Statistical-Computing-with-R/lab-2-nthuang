...
(
  ggplot(data = surveys, 
    ...
    geom_density_ridges(color="steelblue", alpha = .1)+
    labs(x="Weight", y= "Species", title="Species' Weight") 
...
(
  ggplot(data = surveys, 
    ...
    geom_jitter(color="steelblue", alpha = .005) +
    labs(x="Weight", y= "Species", title="Species' Weight") +
    scale_fill_manual(values = c("blue", "yellow", "red", "green", "orange", "violet", "brown", "purple"))
...
(
  ggplot(data = surveys, 
    ...
    geom_boxplot() +
    #geom_jitter(color="steelblue", alpha = .005) +
    labs(x = "Weight (g)", y = "", subtitle = "by Species and Genera",
       title = "Rodent Weight") +
    theme(legend.position = "none") + 
    scale_color_manual(values = c("blue", "yellow", "red", "green",        "orange", "violet", "brown", "purple")) +
    annotate("text", y = 14, x = 120, label = "Onychomys") +
    annotate("text", y = 13, x = 250, label = "Dipodomys") +
    annotate("text", y = 12, x = 140, label = "Chaetodipus") +
    annotate("text", y = 11, x = 145, label = "Dipodomys") +
    annotate("text", y = 10, x = 135, label = "Dipodomys") +
    annotate("text", y = 9, x = 110, label = "Reithrodontomys") +
    annotate("text", y = 8, x = 120, label = "Peromyscus") +
    annotate("text", y = 7, x = 125, label = "Onychomys") +
    annotate("text", y = 6, x = 200, label = "Sigmodon") +
    annotate("text", y = 5, x = 95, label = "Reithrodontomys") +
    annotate("text", y = 4, x = 110, label = "Perognathus") +
    annotate("text", y = 3, x = 125, label = "Peromyscus") +
    annotate("text", y = 2, x = 140, label = "Chaetodipus") +
    annotate("text", y = 1.5, x = 260, label = "Neotoma")
)
