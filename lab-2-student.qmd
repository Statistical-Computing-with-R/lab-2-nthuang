...
30,463 × 15, given in Column specification
...
(
  ggplot(data = surveys, 
    ...
    geom_point(alpha = .5) +
    facet_wrap("species") + 
    labs(x="Weight", y= NULL, title="Different Species' Weight vs Hindfoot Length", subtitle="Hindfoot Length")
)
...
(
  ggplot(data = surveys, 
    ...
    geom_jitter(color="steelblue", alpha = .1) +
    labs(x="Species", y= "Weight", title="Species' Weight") +
...
p-value:2e-16 pretty much 0
Based on the p-value being basically 0, we can reject the null hypothesis. We can conclude that there is at least one rodent species with a  different population mean weight.
